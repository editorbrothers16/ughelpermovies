...
export async function getStaticPaths() {
    return{
        paths: [
          { params: { movie:'Dunki'}},
          { params: { movie:'Salaar'}},
          { params: { movie:'12thFail'}},
          { params: { movie:'MainAtalHoon'}},
          { params: { movie:'Fighter'}},
          { params: { movie:'KadakSingh'}},
          { params: { movie:'MerryChristmas'}},
          { params: { movie:'Ghoomer'}}
          ],fallback: false
...
const {movie} = params;
 let dat = await  fs.promises.readFile('movdata/P2.json', "utf-8")
...
const response = await fetch(tif + '?language=en-US', {
    method: 'GET',
    headers: {
